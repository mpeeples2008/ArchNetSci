...
```{r geo_layout, warning=F, message=F, fig.heigh=7, fig.width=7}
library(sf)
library(ggmap)
...
```{r Fig6_3a, message=F, warning=F, fig.width=7, fig.height=7}
...
```{r Fig6_3c, message=F, warning=F, fig.width=7, fig.height=7}
library(edgebundle)
load("data/Peeples2018.Rdata")
...
```{r Fig6_9, warning=F, message=F, fig.height=7, fig.width=7}
# initialize libraries
library(igraph)
library(ggraph)
library(ape)
...
```{r Fig6_13, fig.height=7, fig.width=7, warning=F, message=F}
library(png)
library(igraph)
...
```{r Fig6_16, warning=F, message=F, fig.height=3, fig.width=7}
...
```{r Fig6_17, fig.width=7, fig.height=7, warning=F, message=F}
