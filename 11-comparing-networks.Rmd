...
Note that the DeltaCon function was broken by a recent update to the Matrix package. I have left this example here in the meantime and it will run and update once a solution has been found. In the meantime, you can run this in older verison of the Matrix package.
```
