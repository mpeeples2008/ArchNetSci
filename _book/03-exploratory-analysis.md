...
#> $vpath
#> $vpath[[1]]
#> + 5/31 vertices, named, from 54b00af:
...
#> $vertices
#> + 2/30 vertices, named, from 54b116b:
...
components
#> [[1]]
#> IGRAPH 572b0e4 UN-- 30 167 -- 
#> + attr: name (v/c)
#> + edges from 572b0e4 (vertex names):
#>  [1] Apache.Creek--Casa.Malpais        
...
#> 
#> [[2]]
#> IGRAPH 572b10b UN-- 1 0 -- 
#> + attr: name (v/c)
#> + edges from 572b10b (vertex names):
...
#> 
#> $cut
#> + 1/167 edge from 54b0786 (vertex names):
#> [1] Ojo Bonito--Baca Pueblo
#> 
#> $partition1
#> + 1/30 vertex, named, from 54b0786:
#> [1] Baca Pueblo
#> 
#> $partition2
#> + 29/30 vertices, named, from 54b0786:
#>  [1] Apache Creek          Casa Malpais         
...
#> + 9/31 vertices, named, from 54b00af:
