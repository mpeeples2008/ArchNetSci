...
## $vpath
## $vpath[[1]]
## + 5/31 vertices, named, from 2cf72de:
...
```
## $vertices
## + 2/30 vertices, named, from 2cf83a2:
...
```
## [[1]]
## IGRAPH 2f1dba1 UN-- 30 167 -- 
## + attr: name (v/c)
## + edges from 2f1dba1 (vertex names):
...
## 
## [[2]]
## IGRAPH 2f1dbb8 UN-- 1 0 -- 
## + attr: name (v/c)
## + edges from 2f1dbb8 (vertex names):
```
...
## 
## $cut
## + 1/167 edge from 2cf7b34 (vertex names):
## [1] Ojo Bonito--Baca Pueblo
## 
## $partition1
## + 1/30 vertex, named, from 2cf7b34:
## [1] Baca Pueblo
## 
## $partition2
## + 29/30 vertices, named, from 2cf7b34:
...
```
## + 9/31 vertices, named, from 2cf72de:
