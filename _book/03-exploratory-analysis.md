...
#> $vpath
#> $vpath[[1]]
#> + 5/31 vertices, named, from 2fca5aa:
...
#> $vertices
#> + 2/30 vertices, named, from 2fcb66f:
...
components
#> [[1]]
#> IGRAPH 31fc2b8 UN-- 30 167 -- 
#> + attr: name (v/c)
#> + edges from 31fc2b8 (vertex names):
#>  [1] Apache.Creek--Casa.Malpais        
...
#> 
#> $cut
#> + 1/167 edge from 2fcacff (vertex names):
#> [1] Ojo Bonito--Baca Pueblo
#> 
#> $partition1
#> + 1/30 vertex, named, from 2fcacff:
#> [1] Baca Pueblo
#> 
#> $partition2
#> + 29/30 vertices, named, from 2fcacff:
#>  [1] Apache Creek          Casa Malpais         
...
#> + 9/31 vertices, named, from 2fca5aa:
