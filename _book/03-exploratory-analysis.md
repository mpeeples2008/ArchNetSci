...
## $vpath
## $vpath[[1]]
## + 5/31 vertices, named, from 0b73fc3:
...
```
## $vertices
## + 2/30 vertices, named, from 0b76e90:
...
```
## [[1]]
## IGRAPH 0e86d4e UN-- 30 167 -- 
## + attr: name (v/c)
## + edges from 0e86d4e (vertex names):
...
## 
## [[2]]
## IGRAPH 0e86d77 UN-- 1 0 -- 
## + attr: name (v/c)
## + edges from 0e86d77 (vertex names):
```
...
## 
## $cut
## + 1/167 edge from 0b745ae (vertex names):
## [1] Ojo Bonito--Baca Pueblo
## 
## $partition1
## + 1/30 vertex, named, from 0b745ae:
## [1] Baca Pueblo
## 
## $partition2
## + 29/30 vertices, named, from 0b745ae:
...
```
## + 9/31 vertices, named, from 0b73fc3:
