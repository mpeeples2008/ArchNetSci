...
#> $vpath
#> $vpath[[1]]
#> + 5/31 vertices, named, from 1adcb1a:
...
#> $vertices
#> + 2/30 vertices, named, from 1add9c3:
...
components
#> [[1]]
#> IGRAPH 1cfe31b UN-- 30 167 -- 
#> + attr: name (v/c)
#> + edges from 1cfe31b (vertex names):
#>  [1] Apache.Creek--Casa.Malpais        
...
#> 
#> $cut
#> + 1/167 edge from 1add26f (vertex names):
#> [1] Ojo Bonito--Baca Pueblo
#> 
#> $partition1
#> + 1/30 vertex, named, from 1add26f:
#> [1] Baca Pueblo
#> 
#> $partition2
#> + 29/30 vertices, named, from 1add26f:
#>  [1] Apache Creek          Casa Malpais         
...
#> + 9/31 vertices, named, from 1adcb1a:
