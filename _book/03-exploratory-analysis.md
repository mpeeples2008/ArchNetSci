...
#> $vpath
#> $vpath[[1]]
#> + 5/31 vertices, named, from 3929f59:
...
#> $vertices
#> + 2/30 vertices, named, from 392b074:
...
components
#> [[1]]
#> IGRAPH 3b5f2f4 UN-- 30 167 -- 
#> + attr: name (v/c)
#> + edges from 3b5f2f4 (vertex names):
#>  [1] Apache.Creek--Casa.Malpais        
...
#> 
#> $cut
#> + 1/167 edge from 392a6ad (vertex names):
#> [1] Ojo Bonito--Baca Pueblo
#> 
#> $partition1
#> + 1/30 vertex, named, from 392a6ad:
#> [1] Baca Pueblo
#> 
#> $partition2
#> + 29/30 vertices, named, from 392a6ad:
#>  [1] Apache Creek          Casa Malpais         
...
#> + 9/31 vertices, named, from 3929f59:
