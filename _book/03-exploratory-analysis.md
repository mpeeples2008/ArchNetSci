...
## $vpath
## $vpath[[1]]
## + 5/31 vertices, named, from 5825de8:
...
```
## $vertices
## + 2/30 vertices, named, from 5826e34:
...
```
## [[1]]
## IGRAPH 5a99ada UN-- 30 167 -- 
## + attr: name (v/c)
## + edges from 5a99ada (vertex names):
...
## 
## [[2]]
## IGRAPH 5a99b0a UN-- 1 0 -- 
## + attr: name (v/c)
## + edges from 5a99b0a (vertex names):
```
...
## 
## $cut
## + 1/167 edge from 5826444 (vertex names):
## [1] Ojo Bonito--Baca Pueblo
## 
## $partition1
## + 1/30 vertex, named, from 5826444:
## [1] Baca Pueblo
## 
## $partition2
## + 29/30 vertices, named, from 5826444:
...
```
## + 9/31 vertices, named, from 5825de8:
