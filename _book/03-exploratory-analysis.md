...
#> $vpath
#> $vpath[[1]]
#> + 5/31 vertices, named, from be15887:
...
#> $vertices
#> + 2/30 vertices, named, from be16730:
...
components
#> [[1]]
#> IGRAPH c053031 UN-- 30 167 -- 
#> + attr: name (v/c)
#> + edges from c053031 (vertex names):
#>  [1] Apache.Creek--Casa.Malpais        
...
#> 
#> $cut
#> + 1/167 edge from be15fdc (vertex names):
#> [1] Ojo Bonito--Baca Pueblo
#> 
#> $partition1
#> + 1/30 vertex, named, from be15fdc:
#> [1] Baca Pueblo
#> 
#> $partition2
#> + 29/30 vertices, named, from be15fdc:
#>  [1] Apache Creek          Casa Malpais         
...
#> + 9/31 vertices, named, from be15887:
