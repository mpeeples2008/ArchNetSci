...
#> $vpath
#> $vpath[[1]]
#> + 5/31 vertices, named, from 629cba9:
...
#> $vertices
#> + 2/30 vertices, named, from 629db99:
...
components
#> [[1]]
#> IGRAPH 64eda3d UN-- 30 167 -- 
#> + attr: name (v/c)
#> + edges from 64eda3d (vertex names):
#>  [1] Apache.Creek--Casa.Malpais        
...
#> 
#> [[2]]
#> IGRAPH 64eda61 UN-- 1 0 -- 
#> + attr: name (v/c)
#> + edges from 64eda61 (vertex names):
...
#> 
#> $cut
#> + 1/167 edge from 629d1d2 (vertex names):
#> [1] Ojo Bonito--Baca Pueblo
#> 
#> $partition1
#> + 1/30 vertex, named, from 629d1d2:
#> [1] Baca Pueblo
#> 
#> $partition2
#> + 29/30 vertices, named, from 629d1d2:
#>  [1] Apache Creek          Casa Malpais         
...
#> + 9/31 vertices, named, from 629cba9:
