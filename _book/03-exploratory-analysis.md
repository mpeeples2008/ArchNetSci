...
## $vpath
## $vpath[[1]]
## + 5/31 vertices, named, from 58f5e50:
...
```
## $vertices
## + 2/30 vertices, named, from 58f7288:
...
```
## [[1]]
## IGRAPH 5b61dd0 UN-- 30 167 -- 
## + attr: name (v/c)
## + edges from 5b61dd0 (vertex names):
...
## 
## [[2]]
## IGRAPH 5b61df8 UN-- 1 0 -- 
## + attr: name (v/c)
## + edges from 5b61df8 (vertex names):
```
...
## 
## $cut
## + 1/167 edge from 58f667d (vertex names):
## [1] Ojo Bonito--Baca Pueblo
## 
## $partition1
## + 1/30 vertex, named, from 58f667d:
## [1] Baca Pueblo
## 
## $partition2
## + 29/30 vertices, named, from 58f667d:
...
```
## + 9/31 vertices, named, from 58f5e50:
