...
## $vpath
## $vpath[[1]]
## + 5/31 vertices, named, from 719450c:
...
```
## $vertices
## + 2/30 vertices, named, from 7195561:
...
```
## [[1]]
## IGRAPH 73a5ccc UN-- 30 167 -- 
## + attr: name (v/c)
## + edges from 73a5ccc (vertex names):
...
## 
## [[2]]
## IGRAPH 73a5ce4 UN-- 1 0 -- 
## + attr: name (v/c)
## + edges from 73a5ce4 (vertex names):
```
...
## 
## $cut
## + 1/167 edge from 7194cbe (vertex names):
## [1] Ojo Bonito--Baca Pueblo
## 
## $partition1
## + 1/30 vertex, named, from 7194cbe:
## [1] Baca Pueblo
## 
## $partition2
## + 29/30 vertices, named, from 7194cbe:
...
```
## + 9/31 vertices, named, from 719450c:
