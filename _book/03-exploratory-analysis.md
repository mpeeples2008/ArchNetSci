...
## $vpath
## $vpath[[1]]
## + 5/31 vertices, named, from edc90a4:
...
```
## $vertices
## + 2/30 vertices, named, from edc98e6:
...
```
## [[1]]
## IGRAPH ef0c2ab UN-- 30 167 -- 
## + attr: name (v/c)
## + edges from ef0c2ab (vertex names):
...
## 
## [[2]]
## IGRAPH ef0c2bf UN-- 1 0 -- 
## + attr: name (v/c)
## + edges from ef0c2bf (vertex names):
```
...
## 
## $cut
## + 1/167 edge from edc94c5 (vertex names):
## [1] Ojo Bonito--Baca Pueblo
## 
## $partition1
## + 1/30 vertex, named, from edc94c5:
## [1] Baca Pueblo
## 
## $partition2
## + 29/30 vertices, named, from edc94c5:
...
```
## + 9/31 vertices, named, from edc90a4:
