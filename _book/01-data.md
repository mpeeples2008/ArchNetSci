...
|bookdown       |0.37    |CRAN (R 4.2.3) |
|bslib          |0.6.1   |CRAN (R 4.2.3) |
|ca             |0.71.1  |CRAN (R 4.2.3) |
|cccd           |1.6     |CRAN (R 4.2.3) |
|colorspace     |2.1-0   |CRAN (R 4.2.3) |
|concaveman     |1.1.0   |CRAN (R 4.2.3) |
|d3r            |1.1.0   |CRAN (R 4.2.3) |
|deldir         |2.0-2   |CRAN (R 4.2.3) |
|devtools       |2.4.5   |CRAN (R 4.2.3) |
|downlit        |0.4.3   |CRAN (R 4.2.3) |
|dplyr          |1.1.4   |CRAN (R 4.2.3) |
|edgebundle     |0.4.2   |CRAN (R 4.2.3) |
|geosphere      |1.5-18  |CRAN (R 4.2.3) |
|ggforce        |0.4.1   |CRAN (R 4.2.3) |
|ggmap          |4.0.0   |CRAN (R 4.2.3) |
|ggplot2        |3.4.4   |CRAN (R 4.2.3) |
|ggplotify      |0.1.2   |CRAN (R 4.2.3) |
|ggpubr         |0.6.0   |CRAN (R 4.2.3) |
|ggraph         |2.1.0   |CRAN (R 4.2.3) |
|ggrepel        |0.9.5   |CRAN (R 4.2.3) |
|ggsn           |NA      |NA             |
|GISTools       |NA      |NA             |
|graphkernels   |1.6.1   |CRAN (R 4.2.3) |
|igraph         |2.0.1.1 |CRAN (R 4.2.2) |
|intergraph     |2.0-4   |CRAN (R 4.2.3) |
|knitr          |1.45    |CRAN (R 4.2.3) |
|latticeExtra   |0.6-30  |CRAN (R 4.2.3) |
|maptools       |NA      |NA             |
|Matrix         |1.6-5   |CRAN (R 4.2.3) |
|netdiffuseR    |1.22.6  |CRAN (R 4.2.3) |
|networkD3      |0.4     |CRAN (R 4.2.3) |
|networkDynamic |0.11.4  |CRAN (R 4.2.3) |
|patchwork      |1.2.0   |CRAN (R 4.2.3) |
|pracma         |2.4.4   |CRAN (R 4.2.3) |
|RColorBrewer   |1.1-3   |CRAN (R 4.2.0) |
|Rcpp           |1.0.12  |CRAN (R 4.2.3) |
|reshape2       |1.4.4   |CRAN (R 4.2.3) |
|reticulate     |1.35.0  |CRAN (R 4.2.3) |
|rgeos          |NA      |NA             |
|rjson          |NA      |NA             |
|rmarkdown      |2.25    |CRAN (R 4.2.3) |
|scatterplot3d  |0.3-44  |CRAN (R 4.2.3) |
|sf             |1.0-15  |CRAN (R 4.2.3) |
|SparseM        |1.81    |CRAN (R 4.2.0) |
|statnet        |2019.6  |CRAN (R 4.2.3) |
|superheat      |0.1.0   |CRAN (R 4.2.3) |
|tidyverse      |2.0.0   |CRAN (R 4.2.3) |
|vegan          |2.6-4   |CRAN (R 4.2.3) |
|visNetwork     |2.1.2   |CRAN (R 4.2.3) |
