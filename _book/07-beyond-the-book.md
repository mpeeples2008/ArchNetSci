...
<p><span class="math inline">\(\mathbf{log}(A) =
\frac{\mathbf{log}(P(A)}{(1-P(A))}\)</span></p>
<p>where</p>
<ul>
<li><span class="math inline">\(\mathbf{log}(A)\)</span> is the log odds
of event A</li>
<li><span class="math inline">\(\mathbf{log}(P(A)\)</span> is the
probability of event A occurring</li>
<li><span class="math inline">\(\mathbf{log}(1-(P(A))\)</span> is the
