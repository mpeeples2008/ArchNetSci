...
devtools::install_github("mpeeples2008/archnetpkg")
```

Note that this package installs from a separate repository [found here](https://github.com/mpeeples2008/archnetpkg) which includes all of the dependencies required to run the code in this document but does not include the markdown files. The package folder includes a folder called "extdata" that includes the data and .R scripts used in this project.
